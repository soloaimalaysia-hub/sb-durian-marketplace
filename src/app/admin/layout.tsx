...
import { LayoutDashboard, Users, Palette, ShoppingBag, Settings, LogOut, UserPlus, Store, Home } from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { href: '/admin/homepage', icon: Home, zh: '🏠 首页配置', en: '🏠 Homepage', bm: '🏠 Laman Utama' },
