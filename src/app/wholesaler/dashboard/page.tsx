    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {[
          ...
          { href: '/wholesaler/purchase', icon: Package, zh: '我的采购订单', en: 'My Purchase Orders', bm: 'Pesanan Pembelian Saya', desc_zh: '进行中和历史采购', desc_en: 'Active and past purchases', desc_bm: 'Pembelian aktif dan lalu' },
          ...
          { href: '/wholesaler/profile', icon: Package, zh: '店面设置', en: 'Store Settings', bm: 'Tetapan Kedai', desc_zh: '更新资料', desc_en: 'Update profile', desc_bm: 'Kemaskini profil' },
        ].map((item) => (
